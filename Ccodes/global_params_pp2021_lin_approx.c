...
double primary_prod = 1000.0*1000.0*1.0; //micro gC /m2 /day
...
double bge = 0.20;			//bacterial growth efficiency
double cPperCB = 1.0e+6;			//carbon content per particle
double h1 = 3.0e-5;			//hydrolysis rate
double mR = 0.0;		//constant loss rate of resource (mA in the manuscript)
double mB = 0.02; 		//mortality of bacteria (attached)
//double mF = 0.01;
